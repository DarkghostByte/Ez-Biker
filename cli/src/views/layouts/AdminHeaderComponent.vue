<template>
    ...
    <header class="flex items-center h-20 px-6 sm:px-10 bgHeader">
        ...
        <div class="flex flex-shrink-0 items-center ml-auto">
          <router-link to="/auth/index" class="border-l pl-3 ml-3 space-x-1">
            <button to="admin/loj" class="relative p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-600 focus:bg-gray-100 focus:text-gray-600 rounded-full">
